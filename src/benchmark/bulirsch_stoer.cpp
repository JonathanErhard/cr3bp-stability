...
int main(){
    ...
    const std::string integrator_name = "Bulirsch_Stoer";

    odeint::bulirsch_stoer subject(INTEGRATOR_PARAMETERS::absolute_tolerance,INTEGRATOR_PARAMETERS::relative_tolerance);
